...
<body>
    ...
    <div class="main">
        ...
        <p>The corresponding controller for this view file is:</p>
    ...
    <div class="footer">Page rendered with <?php echo $this->benchmark->memory_usage(); ?> in <strong><?php echo $this->benchmark->elapsed_time(); ?></strong> seconds. <?php echo  (config_item('ENVIRONMENT') === 'development') ?  'LavaLust Version <strong>' . config_item('VERSION') . '</strong>' : '' ?>
    </div>
